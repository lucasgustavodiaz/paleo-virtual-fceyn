  ...
  return (
    <div className="flex gap-6 md:gap-10">
      ...
      >
        ...
        <LogoTextoUNLPAM className="hidden h-auto w-[190px] drop-shadow-[0_0_14px_rgba(0,126,150,0.1)] sm:inline-block dark:drop-shadow-[0_0_16px_rgba(89,243,255,0.16)] dark:invert" />
      </Link>
    </div>
  );
}
